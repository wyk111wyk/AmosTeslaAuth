...
public class AuthManager {
    ...
    @AppStorage("AccessToken") private var savedAccessToken = ""
    @AppStorage("RefreshToken") private var savedrefreshToken = ""
    @AppStorage("ExpiredTS") private var expiredTS: Double = 0
    ...
    public func requestToken() async throws -> HTTPHeaders {
        ...
        if hasExpired() {
            ...
            let headers = try await refreshAccessToken(savedrefreshToken)
            return headers
        }else {
